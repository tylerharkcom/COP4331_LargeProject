    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="600" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/a6a01f1ec85e68ec/166b7457-49fa-475d-a34b-f1885c064e94/1280x853.jpg">
        </td>
      </tr>
    </tbody>
...
<td align="center" bgcolor="white" class="inner-td" style="border-radius:0px; font-size:16px; text-align:center; background-color:white;padding: 0px 0px 25px 0px">
    ...
    </table><table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="4e6553b4-1a27-4bd6-abae-69f965cc9ded">
    <tbody>
      <tr>
